...
#include "key_memory.h"
   ...
   std::pair<std::string,int> button_pess::find_button_pos(sf::RenderWindow &window, const sf::Event &event,std::map<std::string,int> memory_map,std::vector<std::string> id_memory)
   {
